                        ...
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/article') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="article_name" placeholder="文章名称" data-parsley-required="true" data-parsley-required-message="请输入文章名称" value="{{ old('article_name') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="article_des">文章描述 * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="article_des" placeholder="文章描述" data-parsley-required="true" data-parsley-required-message="请输入文章描述" value="{{ old('article_des') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
