            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/article/'.$article['article']['id']) }}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="article_name">文章名称 * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="article_name" placeholder="文章名称" data-parsley-required="true" data-parsley-required-message="请输入文章名称" value="{{$article['article']['article_name']}}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="article_des">文章描述 * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="article_des" placeholder="文章描述" data-parsley-required="true" data-parsley-required-message="请输入文章描述" value="{{ $article['article']['article_des'] }}"/>
                                </div>
                            </div>
                            <div class="form-group">
