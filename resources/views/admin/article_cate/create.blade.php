...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">新增文章分类 <small>header small text goes here...</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/article-cate') }}" method="POST">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="cate_name">分类名称 * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="cate_name" placeholder="分类名称" data-parsley-required="true" data-parsley-required-message="请输入分类名称名称" value="{{ old('cate_name') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="cate_des">分类描述 * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="cate_des" placeholder="分类描述" data-parsley-required="true" data-parsley-required-message="请输入分类描述" value="{{ old('cate_des') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
