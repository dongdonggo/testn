...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">文章分类列表 <small>header small text goes here...</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                    ...
                    <div class="panel-body">
                        @if(auth('admin')->user()->can('article_cate.add'))
                        <a href="{{ url('admin/article-cate/create') }}">
...
@section('admin-js')
    ...
    <script src="{{ asset('asset_admin/js/article_cate.list.js')}}"></script>
    <script>
        $(function(){
